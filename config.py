...
class Config(object):
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://KazmaRocks:RockKazama2910@kazamarocks.bpeomdu.mongodb.net/?retryWrites=true&w=majority")
